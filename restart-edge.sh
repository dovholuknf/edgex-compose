...
docker compose -f docker-compose.cwd.yml exec -it ziti-controller bash -c "cat /persistent/setup-ziti.sh > /persistent/setup-ziti.sh"
docker compose -f docker-compose.cwd.yml exec -it ziti-controller bash -c "chmod +x /persistent/setup-ziti.sh"
docker compose -f docker-compose.cwd.yml exec -it ziti-controller bash -c /persistent/setup-ziti.sh
